...
from data_visualization_v2 import plot_correlation_graph, plot_dispersion_graphs, plot_histograms
...
def explore_data(data: pd.DataFrame, save_plots = False) -> Tuple[Any, int]:
    ...
    if save_plots:
        ...
        plot_dispersion_graphs(data, X_COLUMNS_NAMES, Y_COLUMN_NAME, filename_disp="Dispersion_graph.png")
